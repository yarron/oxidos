  ...
  var Renderer = function () {
    ...
    var tplDialogInfo = {
      image: function (lang, options) {
        ...
        var body = '<div class="note-group-select-from-files">' +
                     '<label>' + lang.image.image + '</label><br/>' +
                     '<a class="btn btn-default btn-image" >'+lang.image.selectFromFiles+'</a>' +
                     imageLimitation +
                   '</div>' +
                   '<div >' +
                     '<label>' + lang.image.url + '</label>' +
                     '<input class="note-image-url form-control span12" type="text" disabled="disabled" />' +
                   '</div>';
