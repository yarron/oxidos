        ...
        else
        {
            try
            {
                ...
                if(Request::current()!="" && Request::current()->directory() == "Admin"){
                    echo Request::factory(Route::get('admin_errors')->uri($attributes))->execute()->send_headers()->body();
                }
                else{
                    echo Request::factory(Route::get('errors')->uri($attributes))->execute()->send_headers()->body();
                }
