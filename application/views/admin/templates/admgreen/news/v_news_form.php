    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <div class="btn-group btn-group-sm pull-right" role="group" >
                ...
                <a data-toggle="tooltip" title="<?=$text['button_abort']?>" href="/admin/news" class="btn btn-primary"><i class="glyphicon glyphicon-share-alt"></i></a>
            </div>
        </div>
        <div class="panel-body">
            ...
            <?if($errors):?>
                ...
                <?endforeach?>
            <?endif?>
            <?=Form::open('admin/news/page/'.$page.'/'.$data['action'].'/'.$data['id'], array('enctype' => 'multipart/form-data', "id" => "form", "role"=> "form", "class"=> "form-horizontal"))?>
            <div role="tabpanel">
                                ...
                                <? foreach ($languages as $language) : ?>
                                    <div role="tabpanel" class="tab-pane" id="language<?=$language->id ?>">
                                        ...
                                        <div class="form-group <?=isset($errors['title']) ? 'has-error' : ''?>">
                                            <?=Form::label('new_description['.$language->id.'][title]', '<i class="glyphicon glyphicon-asterisk"></i>&nbsp;'.$text['text_title'], array("class" => "col-sm-2 control-label"))?>
                                            <div class="col-sm-10"><?=Form::input('new_description['.$language->id.'][title]', isset($data['new_description']) ? $data['new_description'][$language->id]['title'] : "", array('size' => 100, 'class'=>'form-control','id'=>'title-'.$language->id))?></div>
                                        </div>
                                        <div class="form-group">
                                            <?=Form::label('new_description['.$language->id.'][seo_title]', $text['text_seo_title'], array("class" => "col-sm-2 control-label"))?>
                                            <div class="col-sm-10"><?=Form::input('new_description['.$language->id.'][seo_title]', isset($data['new_description']) ? $data['new_description'][$language->id]['seo_title']: "", array('size' => 100, 'class'=>'form-control','id'=>'seo_title-'.$language->id))?></div>
                                        </div>
                                        <div class="form-group">
                                            <?=Form::label('new_description['.$language->id.'][meta_description]', $text['text_meta_description'], array("class" => "col-sm-2 control-label"))?>
                                            <div class="col-sm-10"><?=Form::input('new_description['.$language->id.'][meta_description]', isset($data['new_description']) ? $data['new_description'][$language->id]['meta_description'] : "", array('size' => 100, 'class'=>'form-control'))?></div>
                                        </div>
                                        <div class="form-group">
                                            <?=Form::label('new_description['.$language->id.'][meta_keywords]', $text['text_meta_keywords'], array("class" => "col-sm-2 control-label"))?>
                                            <div class="col-sm-10"><?=Form::input('new_description['.$language->id.'][meta_keywords]', isset($data['new_description']) ? $data['new_description'][$language->id]['meta_keywords'] : "", array('size' => 100, 'class'=>'form-control'))?></div>
                                        </div>
                                        <div class="form-group <?=isset($errors['description']) ? 'has-error' : ''?>">
                                            <?=Form::label('new_description['.$language->id.'][description]',  '<a data-toggle="tooltip" title="'.$text['button_preview'].'" data-lang="'.$language->id.'" class="btn btn-default btn-preview" data-loading-text="'.$text['button_loading'].'"><i class="glyphicon glyphicon-eye-open"></i></a> <i class="glyphicon glyphicon-asterisk"></i>&nbsp;'.$text['text_description'], array("class" => "col-sm-2 control-label"))?>
                                            <div class="col-sm-10"><?=Form::textarea('new_description['.$language->id.'][description]',$value = isset($data['new_description']) ? $data['new_description'][$language->id]['description'] : "", array('cols' => 40, 'rows' => 5, 'class'=>'form-control','id'=>'description-'.$language->id))?></div>
                                        </div>
                                    </div>
                                <?endforeach?>
                            </div>
