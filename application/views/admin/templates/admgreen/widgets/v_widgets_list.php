                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?if(count($widgets) > 0):?>
                            ...
                            <tr>
                                <td><?=$widget['name']?></td>
                                <td><?=Html::anchor('admin/widgets/'.$widget['action'], '<i class="glyphicon glyphicon-edit"></i>', array('class'=>'btn btn-primary btn-xs','data-toggle'=>"tooltip", 'title'=>$text['text_edit']));?></td>
                                <td align="center">
                                    <?if($widget['status'] == 0):?>
